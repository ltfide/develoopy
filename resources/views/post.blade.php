...
@section('container')    
{{-- single post start --}}
    <section class="lg:container lg:flex gap-4 justify-between bg-white lg:bg-transparent lg:w-5/6 mt-28 px-8 mx-auto lg:px-0">
        <div class="lg:w-3/4 w-full lg:bg-white lg:shadow lg:rounded lg:py-6 lg:px-9 mb-8">
