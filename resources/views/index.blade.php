...
@section('container')
    ...
    <nav class="mt-16 mb-5 w-full bg-[#219150] px-8">
      <section class="lg:container mx-auto flex flex-1 flex-col-reverse lg:flex-row justify-between items-center">
        <div class="lg:w-1/2 text-center lg:text-left py-8">
          ...
          <p class="lg:text-2xl text-xl my-6 text-white">Sebuah tempat belajar seputar <span class="underline">programming</span>, <span class="underline">Matematika</span> dan <span class="underline">Bahasa Inggris.</span></p>
    ...
    <section class="lg:container mx-auto px-8">
      <div class="bg-white rounded-3xl lg:my-10 py-6 shadow-lg">
        <h1 class="text-center text-2xl text-slate-600 font-bold">Semua Kategory</h1>
    ...
    <section class="lg:container mx-auto lg:my-10 px-8">
