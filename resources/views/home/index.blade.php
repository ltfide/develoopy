...
@section('container')
    ...
    <section class="lg:py-28 px-8 lg:px-0" id="artikel">
      <div class="lg:container mx-auto lg:px-0 lg:w-5/6">
        <h1 class="text-center text-4xl text-slate-600 font-medium"  >POST Terbaru</h1>
    ...
    <section class="lg:py-10 px-8 lg:px-0" id="category">
      <div class="lg:container mx-auto lg:px-0 lg:w-5/6">
        <h1 class="text-center text-slate-600 text-4xl font-medium mb-8">Pilih Kategori</h1>
